...
fuente conocida, sin cliente dedicado.
...
| Autoridades portuarias (APPB, APG, APM) | Tres organizaciones CKAN reales confirmadas en vivo, no solo Puerto Bolívar: `autoridad-portuaria-de-puerto-bolivar-appb` (246 paquetes — el conteo más alto de cualquier organización del portal: tráfico de buques, carga import/export por producto con tonelaje y país de origen/destino, obras de inversión, actualizado hasta agosto 2026), `autoridad-portuaria-de-guayaquil-apg` (6 paquetes: distributivo de personal, remuneración mensual, buques por muelle, tonelaje y contenedores de importación/exportación), `apm` = Autoridad Portuaria de **Manta**, no APM Terminals (11 paquetes: buques arribados, TEUs, carga, vehículos, turistas) → RESEARCH.md § Vigésimo tercera pasada, § Vigésimo sexta pasada |
