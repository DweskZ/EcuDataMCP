...
| Ministerio de Salud Pública | Parcial | Gacetas de Inmunoprevenibles ya cubiertas (ver Hecho). Dominio vivo con contenido real y sección LOTAIP; solo 8 paquetes en su organización CKAN — sub-objetivos sin explorar: las otras gacetas semanales del MSP (vectoriales, enfermedades de la piel/reemergentes, indicadores — mismo patrón WordPress, confirmado en vivo que existen), la "Gacetas Epidemiológicas" general (`gacetas-epidemiologicas-2`, distinta de inmunoprevenibles), plataforma de datos COVID-19, GeoSalud en Cifras → RESEARCH.md § Séptima pasada, § Vigésimo tercera pasada, § Vigésimo sexta pasada |
