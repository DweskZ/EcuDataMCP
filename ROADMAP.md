...
- [ ] **ENEMDU/mercado laboral 2024-2026 no está en ningún tool actual, aunque INEC sigue publicándolo mensualmente.** Verificado en vivo 2026-08-29 (pedido de Daniel, con VPN a LatAm): ANDA tope en 2023, la página estática de INEC `ecuadorencifras.gob.ec/empleo-marzo-2018/` tope en abril 2023, y CKAN (`instituto-nacional-de-estadisticas-y-censos`, 94 datasets) tope en 2021 para ENEMDU — sin embargo, la sección `/institucional/noticias/` del mismo sitio sí tiene un comunicado de mayo 2026 ("...86 mil personas menos... mayo 2026 frente a mayo 2025") que enlaza un boletín real y descargable: `documentos/web-inec/EMPLEO/2026/Mayo_2026/202605_MercadoLaboral.pdf`, mismo patrón de ruta (`EMPLEO/{año}/{Mes}_{año}/...`) que los boletines viejos ya conocidos. Conclusión: INEC no dejó de publicar ENEMDU, dejó de actualizar la página estática de "Empleo" y ahora solo anuncia boletines nuevos vía Noticias. Acción: scrapear `/institucional/noticias/` (paginado, ~43 links por página) filtrando por palabras clave (empleo/desempleo/laboral/ENEMDU) para descubrir el boletín mensual vigente y sus archivos adjuntos, en vez de depender solo de la página estática de tema. Mismo riesgo puede aplicar a otros temas de `search_inec_estadisticas` cuya página de tema esté igual de abandonada — no se auditó ninguno más todavía. → RESEARCH.md § Novena pasada
